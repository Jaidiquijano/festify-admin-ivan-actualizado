...
import { listFestivales } from "@/services/festivales";
...
export default function Festivales() {
   const [festivaless,setFestivals] = useState<Festival[]>([]); 

       useEffect(() => {
        listFestivales().then((fes)=>{
            setFestivals(fes);
        }).catch((error)=>{
            console.log(error)
        }
            ...
            <main className="max-w-7xl mx-auto px-4 py-8">
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Link to="./festivalNuevo.tsx" className="px-3 py-2 rounded-lg bg-neutral-900 text-white text-sm">Nuevo festival</Link>
                    </div>
                </div>
                    ...
                    <article data-festival data-name="SunWave Fest" data-city="Barcelona" data-start="2025-07-12" data-end="2025-07-14"
                        ...
                        <div className="flex items-start justify-between gap-3">
                            <header>
                              ...
                              <p className="mt-1 text-sm text-neutral-600">{festival.abaout}</p>
                            </header>
                        ...
                        <dl className="mt-4 space-y-2 text-sm">
                            <div className="flex items-center gap-2">
                                ...
                                <dd>{festival.from} — {festival.to}</dd>
                            </div>
                            <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-2">
                                <dt className="text-neutral-500">💶</dt>
                                <dd>{festival.priceFrom} - {festival.priceTo}</dd>
                            </div>
                        </dl>
